...
namespace EventPlanner.WEBAPI.Controllers
{
    ...
    public class ServicesController : ControllerBase
    {
        ...
        public async Task<List<ServicesDTO>> GetEbayServices(string? search)
        {
            ...
            doc.Load(stream);
            var HeaderNames = doc.DocumentNode.SelectNodes("//div[@class='s-item__title']");
            var Descriptions = doc.DocumentNode.SelectNodes("//div[@class='s-item__subtitle']");
            var Prices = doc.DocumentNode.SelectNodes("//span[@class='s-item__price']");
